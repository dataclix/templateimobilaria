...
const Banner: React.FC = () => {
  return (
    <div className="relative h-[calc(100dvh-3.5rem)] font-montserrat overflow-hidden bg-re-base">
      ...
      <motion.div 
        className="absolute top-[10%] right-[5%] w-64 h-64 rounded-full bg-re-accent opacity-20 blur-3xl"
        animate={{ 
          scale: [1, 1.2, 1],
      ...
      <motion.div 
        className="absolute bottom-[20%] left-[5%] w-48 h-48 rounded-full bg-re-accent opacity-10 blur-3xl"
        animate={{ 
          scale: [1, 1.1, 1],
      ...
      <div className="container mx-auto h-full flex items-center px-[6%]">
        ...
        >
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight tracking-tight mb-6 font-montserrat">
            Encontre o Imóvel dos Seus <span className="text-re-accent">Sonhos</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link 
              href="/imoveis"
              className="inline-block bg-re-accent text-white px-8 py-3 rounded-lg font-semibold hover:bg-[#c46a1b] transition-all duration-300 shadow-lg hover:shadow-xl text-center font-poppins"
            >
              Explorar Imóveis
            </Link>
            <Link 
        ...
        <div className="hidden md:block w-1/2 h-full relative">
          <motion.div
            ...
            transition={{ duration: 0.8, ease: "easeOut" }}
          >
            <div className="absolute inset-0 bg-gradient-to-t from-re-base/30 to-transparent z-[1]"></div>
            <img
